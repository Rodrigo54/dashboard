...
export const breadcrumbItemVariants = cva(
  'inline-flex items-center gap-1.5 transition-colors cursor-pointer last:font-normal last:pointer-events-none',
  {
    variants: {
      zColor: {
        muted: 'hover:text-muted-foreground last:text-muted-foreground',
        strong: 'hover:text-foreground last:text-foreground',
        primary: 'hover:text-primary-foreground last:text-primary-foreground',
      },
    },
    defaultVariants: {
      zColor: 'muted',
