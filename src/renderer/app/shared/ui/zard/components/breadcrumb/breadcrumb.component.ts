...
import { ZardStringTemplateOutletDirective } from '@/shared/ui/zard/directives/string-template-outlet/string-template-outlet.directive';
import { mergeClasses } from '@/shared/ui/zard/utils/merge-classes';
...
export class ZardBreadcrumbItemComponent {
  ...
  */
  ...
  readonly zColor = input<ZardBreadcrumbItemVariants['zColor']>('muted');
  ...
  protected readonly classes = computed(() =>
    mergeClasses(breadcrumbItemVariants({ zColor: this.zColor() }), this.class()),
  );
  protected readonly separatorClasses = computed(() => '[&_svg]:size-3.5');
